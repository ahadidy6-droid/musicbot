...
MOUNT_POINT = "/v38apqvc3xyvv" # put ur mountpoint after / in ""
STREAM_USERNAME = "source" # dont change
STREAM_PASSWORD = "25FiIUtB"#"put your password"

vip_positions = {
                    "vip": Position(5.5, 14.5, 4),
...
"Type 'yes' to confirm else type 'no' to cancel.")
    ...
    async def search_track(self, query, user):
        ...
        ydl_opts = {
            ...
            'cookiefile': 'cookies.txt',  # ← هذا هو المفتاح الصحيح
        }
